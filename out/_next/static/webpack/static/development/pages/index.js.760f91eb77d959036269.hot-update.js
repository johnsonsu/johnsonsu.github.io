...
var NavButton = function NavButton(_ref) {
  ...
  console.log('pathname === href', router.pathname === href);
  var isActive = router.pathname === '/' ? router.pathname === href : router.pathname.startsWith(href);
  return __jsx("div", {
    style: buttonStyle,
    __source: {
...
//# sourceMappingURL=index.js.760f91eb77d959036269.hot-update.js.map